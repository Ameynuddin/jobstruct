      ...
      <section className="text-gray-600 body-font">
        <div className="container h-full  min-h-screen w-full mx-auto flex px-5  md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-gray-900 dark:text-white">Welcome to JobStruct, your ultimate job application management solution! Whether you're a job seeker striving to organize your job hunt or a professional aiming to streamline your career progress, JobStruct is here to help. With user-friendly interface, you can effortlessly track applications, set reminders for follow-ups, and store important documents like resumes and cover letters securely in the cloud. Customize your job tracking fields to suit your unique needs and access your data anytime, anywhere. Simplify your job search and take control of your career journey with JobStruct – your partner in professional success!</p>
