...
function Sidebar() {
  ...
  return (
    <>
      <aside className={`bg-gradient-to-br from-gray-800 to-gray-800/95 fixed inset-0 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-lg transition-transform duration-300 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-80'} xl:translate-x-0`}>
