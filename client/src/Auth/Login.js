...
const Login = () => {
  ...
  const SubmtLogin = async (e) => {
    ...
    if (results.success) {
      ...
      console.log("Login failed: " + results.error);
    }
  };
        ...
        <div className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
          ...
          <form className="p-12 md:p-24" method="post">
            ...
            <div className="text-center">
              <p className="font-semibold text-gray-600  focus:outline-none">
                Don&#x27;t have an account yet?
                <Link to="/register" className="text-sm text-blue-500 dark:text-blue-500 align-baseline hover:underline focus:text-gray-800"> Sign Up
                </Link>
