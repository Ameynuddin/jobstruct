...
const Register = () => {
  ...
  const { RegisterApi } = useData()  // destructure RegisterApi (a function) from useData
        ...
        <div className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
          ...
          <form className="p-12 md:p-24" method='post'>
            ...
            <div className="text-center">
              <p className="font-semibold text-gray-600 focus:outline-none">Already have an account?
                <Link to="/login"
                  className="text-sm text-blue-500 dark:text-blue-500 align-baseline hover:underline focus:text-gray-800"> Log In
                </Link>
              </p>
            </div>
